                ...
                if (line.startsWith("data: ")) {
                  try {
                    ...
                    if (data.done) {
                      ...
                      // Retornar dados incluindo informações de fallback (mas não exibir notificação)
                      const result = {
                      ...
                      // Removido: Não disparar evento de fallback para não incomodar o usuário
                      // O fallback acontece silenciosamente em background
